...
# DatasetNames=("knowledge_person" "knowledge_animal" )
DatasetNames=( "knowledge_plant" "knowledge_product")
...
for DatasetName in ${DatasetNames[@]}; do
    ...
    OUTPUT_FILE=$OUTPUT_PATH/$DatasetName.short_answer.jsonl 
    LOG_FILE=./scripts/$DatasetName.short_answer.log 

    python -u call_gpt4_wanwu_short_answer.py -m gpt-4o-2024-05-13 \
    -i $INPUT_FILE \
    -o $OUTPUT_FILE \
