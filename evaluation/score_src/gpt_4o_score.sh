...
# datasets=("lifevqa" "qwenvqa" "nocaps")
datasets=("visual7w")

sub_dirs=("norag" "image2image" "text2text_gold_query_from_origin_query_image" "text2text_gold_query_from_image_search" "both")


# models=("qwen-vl-max" "qwen25-vl-7b" "deepseek-vl-7b-chat" "chatgpt-4o-latest" "qwen-vl-max-latest")
# models=("qwen-vl-max-latest")
# models=("qwen2.5-vl-7b-kb-2")
# models=("deepseek-vl-7b-chat-2")
models=("qwen25-vl-7b" "chatgpt-4o-latest" "deepseek-vl-7b-chat")
...
for dir in "${datasets[@]}"; do
    for sub_dir in "${sub_dirs[@]}"; do
        for model in "${models[@]}"; do
            ...
            python score_src/gpt_4o_score.py --in_file $file_path -m gpt-4o-2024-05-13 --num_workers 4
        done
    done
done
exit
