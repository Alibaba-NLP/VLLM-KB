...
CKPT_DIR=/mnt/nas-alinlp/zhuochen.zc/others/KnowB2/output/0503_KB2_even
mkdir -p $CKPT_DIR
...
# --ckpt_dir $CKPT_DIR/checkpoint-1878 \
# --merge_lora true \
# --model Qwen/Qwen2.5-VL-7B-Instruct

# Run inference of KB model to get boundary labels
cd /mnt/nas-alinlp/zhuochen.zc/others/KnowB2;
python inference_kb_model.py --model_id_or_path $CKPT_DIR/checkpoint-1878-merged
