...
CKPT_DIR=/mnt/nas-alinlp/zhuochen.zc/others/KnowB2/output/0527_strict_even_full
# mkdir -p $CKPT_DIR
...
--model $MODEL_PATH \
--dataset /mnt/nas-alinlp/zhuochen.zc/others/KnowB2/training_data/0527_strict_even_20k_each/train.jsonl \
--val_dataset /mnt/nas-alinlp/zhuochen.zc/others/KnowB2/training_data/0527_strict_even_20k_each/dev.jsonl \
--output_dir $CKPT_DIR \
...
--report_to wandb \
--run_name "0527_strict_even_full" \
...
python inference_kb_model.py --model_id_or_path $CKPT_DIR/best -s 'strict_even_full'