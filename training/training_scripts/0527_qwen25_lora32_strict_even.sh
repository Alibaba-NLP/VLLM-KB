...
CKPT_DIR=/mnt/nas-alinlp/zhuochen.zc/others/KnowB2/output/0527_strict_even_lora
mkdir -p $CKPT_DIR
...
python inference_kb_model.py --model_id_or_path $CKPT_DIR/best-merged -s 'strict_even_lora'