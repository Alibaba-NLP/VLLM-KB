...
CKPT_DIR=/mnt/nas-alinlp/zhuochen.zc/others/KnowB2/output/0528_more_dev2_lora
mkdir -p $CKPT_DIR
...
python inference_kb_model.py --model_id_or_path $CKPT_DIR/best-merged -s 'more_dev2_lora'