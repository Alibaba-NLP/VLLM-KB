# Contain dev set from lifevqa&qwenvqa...
...
CKPT_DIR=/mnt/nas-alinlp/zhuochen.zc/others/KnowB2/output/0528_more_dev2_full
mkdir -p $CKPT_DIR
...
--val_dataset /mnt/nas-alinlp/zhuochen.zc/others/KnowB2/training_data/0526_more/dev2.jsonl \
--output_dir $CKPT_DIR \
...
--report_to wandb \
--run_name "0528_more_dev2_full_a100" \
...
python inference_kb_model.py --model_id_or_path $CKPT_DIR/best -s 'more_dev2_full'