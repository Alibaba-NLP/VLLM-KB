...
--dataset /mnt/nas-alinlp/zhuochen.zc/others/KnowB2/training_data/0408_less_wanwu/train.jsonl \
--val_dataset /mnt/nas-alinlp/zhuochen.zc/others/KnowB2/training_data/0408_less_wanwu/dev.jsonl \
